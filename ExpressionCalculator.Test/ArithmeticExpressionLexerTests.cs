...
namespace ExpressionCalculator.Test
{
    public class ArithmeticExpressionLexerTests
    {
        ...
        public void Lexer_InputValidExpression_ReturnsTokens()
        {
            ...
            Assert.That(tokenEnumerator.Current, Is.EqualTo("12"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("+"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("45"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("/"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("5"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("-"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("5"));
            ...
            Assert.That(tokenEnumerator.Current, Is.EqualTo("*"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("10"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("/"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("("));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("2"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("+"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo("8"));
            tokenEnumerator.MoveNext();
            Assert.That(tokenEnumerator.Current, Is.EqualTo(")"));
